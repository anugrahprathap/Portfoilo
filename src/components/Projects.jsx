...
function Projects() {
  return (
    <div className="main-content ">
      <h3 className="m-2" style={{ color: "white", textAlign: "left" }}>
        Projects
      </h3>
        ...
        <Col className="ml-0 mx-2  mb-4">
          <Card>
            ...
            <Card.Body className="card-content overflow-auto">
              ...
              data communication between the frontend and backend.Demonstrated
              proficiency in software development and database design, creating
              a responsive and user-friendly e-commerce solution.
            </Card.Body>
          </Card>
        </Col>
      ...
      <h5 className="m-2" style={{ color: "white", textAlign: "left" }}>
        What I Know
      </h5>
      <div className="col-skills flex-nowrap overflow-auto row no-scrollbar">
        ...
        <Col className="mx-2 custom-col" style={{ width: "300px" }}>
          <div className="custom-card-1 text-left">
            <Card.Title
              className="card-heading mt-3 mx-3 "
              style={{ color: "white", textAlign: "left" }}
            >
              More Projects
            </Card.Title>
            <ListGroup variant="flush">
              ...
              >
                ...
                <a
                  href="https://github.com/anugrahprathap/Gender-prediction-v1"
                  style={{
                    backgroundColor: " rgb(37, 32, 32)",
                    color: "white",
                  }}
              ...
              >
                ...
                <a
                  href="https://github.com/anugrahprathap/DoctorAppointment"
                  style={{
                    backgroundColor: " rgb(37, 32, 32)",
                    color: "white",
                  }}
                ...
                >
                  ...
                  >
                    DoctorAppointment App using Python Django and React Js
                  </div>
                </a>
              </ListGroup.Item>
            </ListGroup>
